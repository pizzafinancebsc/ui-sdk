  ...
  return (
    <Svg viewBox="0 0 25 24" {...props}>
      <path
        ...
        fill="#EE4F7A"
      />
      <path d="M11.45 7.72021H6.44995V9.22022H11.45V7.72021Z" fill="#EE4F7A" />
      <path d="M18.2 15.75H13.2V17.25H18.2V15.75Z" fill="#EE4F7A" />
      <path d="M18.2 13.25H13.2V14.75H18.2V13.25Z" fill="#EE4F7A" />
      <path
